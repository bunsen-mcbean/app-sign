...
codesign --deep --timestamp --verbose --force --entitlements "$ENTITLEMENTS" --sign "$IDENTITY" --options runtime jamovi.app/Contents/Frameworks/R.framework/Versions/4.0/Resources/bin/exec/R
